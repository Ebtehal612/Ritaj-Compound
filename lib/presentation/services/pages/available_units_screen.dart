...
import 'package:ritaj_compound/presentation/services/widgets/available_units_content.dart';

class AvailableUnitsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const AvailableUnitsContent(),
    );
  }
}
